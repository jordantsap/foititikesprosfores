    ...
    <div class="box">
        <div class="box-body">
          <div class="form-group">
            ...
            <input type="text" value="{{$color->title}}" class="form-control" id="title" placeholder="Enter Title" disabled>
          </div>
          {{-- <div class="form-group">
          ...
          <div class="checkbox">
            <label>
              <input type="checkbox" name="active" value="{{$color->active?1 == 'checked':''}}" @if ($color->active == 1)
                {{'checked'}}
              @endif> Active
            </label>
          </div>
          <div class="row">
            <div class="form-group col-xs-6">
              ...
              <br>
              <img width="150" height="150" src="{{asset('images/colors/'.$color->image)}}" alt="{{$color->title}}">
            </div>
          </div>
