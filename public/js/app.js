  ...
  methods: {
    ...
    loadProducts: function loadProducts() {
      ...
      axios.get("products").then(function (response) {
        _this2.products = response.data; //   this.loading = false;
      })["catch"](function (error) {
        console.log(error);
      });
    }
...
Vue.component('products', __webpack_require__(/*! ./components/Products.vue */ "./resources/js/components/Products.vue").default); // Vue.component('category-field-value', require('./components/CategoryFieldValue.vue').default);
